...
parameters <- c(secperday=86400, #[half saturation constant/ -]
                kN21 = 0.35, #[mortality rate strain 13.1/sec^-1]
                gaP21 = 0.05/secperday, #[maximum gp rate/sec^-1]
                gpmax21 = ((spain_1982(temp=15, a = -3.509e-02, b= 4.663e-25, c=2.000e+00, r0=2.170e+00))/secperday), #[maximum r rate/sec^-1]
                rmax21 = ((spain_1982(temp=15, a=-2.374e-02, b=4.429e-25, c=2.000e+00, r0=1.512e+00))/secperday), #[maximum grazing rate/sec^-1]
                gmax = 1/secperday, #[mortality rate grazer/sec^-1]
                gaGra = 0.25/secperday, #[half saturation konstant grazer/-]
                kP = 0.5, #[assimilation coefficient/-]
                beta = 0.7, #[remineralization rate/sec^-1]
                tau = 0.05/secperday, #[temperature increase per time step/°C sec^-1]]
                deltatemp = (0.018*ye)/(ye*360*secperday),
...
## 21_INDI, set up model structure for the model
